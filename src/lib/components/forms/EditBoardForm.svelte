...
<form  method="POST" action="?/editBoard"  on:submit|preventDefault={handleSubmit} class="{showEditBoardForm ? "block" : "hidden"} edit-board-form px-6 pt-10 fixed w-11/12 h-[24em] z-10 fade-up overflow-y-auto mx-auto left-0 right-0 top-24 bg-[#101321] rounded-md py-6 shadow-lg drop-shadow-lg shadow-gray-600/90 md:w-[25em] md:h-[27em]">
