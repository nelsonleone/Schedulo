...
<div
    class="snackbar fixed bottom-4 z-[100] right-4 bg-emerald-800 text-white py-3 px-5 rounded-lg shadow-lg animate-snackbar transition duration-500 transform"
